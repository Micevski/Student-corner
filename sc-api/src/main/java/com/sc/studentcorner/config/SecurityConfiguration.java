package com.sc.studentcorner.config;
...
public class SecurityConfiguration {
    ...
    public static class AdminSecurity extends WebSecurityConfigurerAdapter {
        ...
        public AdminSecurity(AuthenticationSuccessHandler successHandler, AuthenticationFailureHandler failureHandler, LogoutSuccessHandler logoutSuccessHandler, AuthenticationEntryPoint authenticationEntryPoint, AdminService adminService, PasswordEncoder passwordEncoder) {
        ...
        protected void configure(HttpSecurity http) throws Exception {
            ...
            http.antMatcher("/api/admin/**")
                    .authorizeRequests()
                    .antMatchers("/api/admin/register")
                    .permitAll()
